...
import { Bell, UserCircle, ArrowRight, ArrowLeft, Star } from "lucide-react";
        ...
        return (
          ...
          >
            <Star
              size={28}
              className={
                active ? "text-green-600 fill-green-600" : "text-gray-400"
              }
            />
          </button>
        );
...
export default function SurveyStep8Page() {
  ...
  const canSubmit = questions.every((_, i) => rates[i] > 0);
  ...
  return (
    <div className="w-full">
      ...
      {/* ================= Steps Bar (الخط معبّى مثل الصورة) ================= */}
...
<div className="absolute -top-3 left-0 right-0 flex items-start justify-between px-1">
  ...
  <div className="flex flex-col items-center gap-2">
    ...
    <span className="text-sm font-semibold text-gray-800">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        {/* ================= Bottom Buttons (مثل الصورة: السابق + التالي + إرسال) ================= */}
  ...
  onClick={() => {
    ...
    router.push("/surveys/start/success");
  }}
