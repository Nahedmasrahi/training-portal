...
export default function SurveyStep5Page() {
  const router = useRouter();

  const questions = useMemo(
    () => [
      "هل تم تقديم أنشطة تدريبية داخل القسم مثل الدورات المحاضرات، ورش العمل",
      "هل تعتقد أن محتوى التدريب شامل لجميع المهارات الأساسية في تخصصك",
      "هل كانت الأنشطة التدريبية تتناسب مع تخصصك؟",
    ],
    []
  );
    ...
    <div className="w-full">
      ...
      <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-14">
            {questions.map((q, idx) => (
              <div key={idx} className="text-right">
                ...
                {/* نفس ترتيب الصورة: نعم يمين، لا وسط، جزئياً يسار */}
        ...
        <div className="mt-10 flex items-center justify-center gap-6">
          ...
          <button
            disabled={!canNext}
            onClick={() => router.push("/surveys/start/step-6")}
