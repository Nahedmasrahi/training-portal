...
export default function SurveyStep6Page() {
  ...
  const question2 =
    "هل كانت الأهداف التدريبية واضحة منذ البداية";

  const [answers3, setAnswers3] = useState(() =>
    Object.fromEntries(
      questions3.map((_, i) => [i, ""])
    )
  );

  const [answer2, setAnswer2] =
    useState("");
    ...
    <div className="w-full">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mt-10 flex items-center justify-center gap-6">
          ...
          <button
            onClick={() =>
              router.push("/surveys/start/step-5")
            }
