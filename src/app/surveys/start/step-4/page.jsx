      ...
      {[1, 2, 3, 4, 5].map((n) => {
        ...
        return (
          ...
          >
            <Star
              size={28}
              className={active ? "text-green-600 fill-green-600" : "text-gray-400"}
            />
          </button>
        );
      })}
...
export default function SurveyStep4Page() {
  ...
  const questions = useMemo(
    () => [
      "كيف تقيم تحفيز المدربين لك على المشاركة الفعالة في التدريب",
      "كيف تجد شرح المدربين للمفاهيم والمحتوى التدريبي",
      "كيف تقيم إجابة المدربين على استفساراتك من حيث الوضوح",
      "كيف تقيم احترام المدربين وتعاملهم مع الطلاب",
    ],
    []
  );
  ...
  return (
    <div className="w-full">
      ...
      {/* ================= Steps Bar (نفس الصورة: الأخضر واصل للنقطة الثانية) ================= */}
      <div className="max-w-5xl mx-auto mb-10">
        <div className="relative">
          {/* Track */}
          <div className="h-2 w-full rounded-full bg-gray-200" />

          {/* Progress: واصل للنقطة الثانية */}
